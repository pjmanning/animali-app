  ...
  <div class="flex min-h-screen bg-white">
              ...
              <div>
                ...
                <div class="mt-1 rounded-md shadow-sm">
                  <input
                    ...
                    type="email"
                    required
                    class="block w-full px-3 py-2 placeholder-gray-400 transition duration-150 ease-in-out border border-gray-300 rounded-md appearance-none focus:shadow-outline-blue focus:border-blue-300 focus:outline-none sm:text-sm sm:leading-5"
                  />
                </div>
              </div>
              ...
              <div class="flex items-center justify-between mt-6">
                ...
                <div class="text-sm leading-5">
                  <a
                    ...
                    class="font-medium transition duration-150 ease-in-out cursor-pointer text-animali-600 hover:text-animali-500 focus:underline focus:outline-none"
    ...
    <div class="relative flex-1 hidden w-0 lg:block">
      <img
        ...
        src="https://unsplash.com/photos/Abj_zUko6Mg/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjQ3MDY2MzM4&force=true&w=1920"
        alt="whale shark"
      />
    </div>
  </div>
